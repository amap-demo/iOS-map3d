...
- (NSString *)titleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        AMapAOI *aoi = self.reGeocode.aois[indexPath.row];
...
- (void)gotoDetailForAOI:(AMapAOI *)aoi
{
    if (aoi != nil)
    {
        AOIDetailViewController *detailViewController = [[AOIDetailViewController alloc] init];
        
        detailViewController.aoi = aoi;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        [self gotoDetailForAOI:self.reGeocode.aois[indexPath.row]];
    }
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    switch (section)
    {
        ...
        case 3: number = self.reGeocode.pois.count;   break;
        case 4: number = self.reGeocode.aois.count;   break;
        default:    break;
    }
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section
{
    ...
    switch (section)
    {
        ...
        case 3: titleForHeader = @"兴趣点信息";   break;
        case 4: titleForHeader = @"兴趣区域信息";   break;
        default: break;
    }
